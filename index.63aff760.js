...
// --public-url /skillbox-npm-less2-4/
...
function postPage(id) {
    ...
    fetch(`https://gorest.co.in/public/v2/posts/${id}`).then(async (response)=>{
        ...
        (0, _redom.setChildren)(body, [
            (0, _redom.el)("h2", post.title),
            (0, _redom.el)("p", post.body),
            (0, _redom.el)("a", {
                href: `/`,
                onclick: navigate
            }, "\u0412\u0435\u0440\u043D\u0443\u0442\u044C\u0441\u044F \u043A \u0441\u043F\u0438\u0441\u043A\u0443")
...
router.on(`/`, ()=>{
    (0, _redom.setChildren)(document.body, postList());
});
...
},{"navigo":"fuSlc","redom":"gT5MM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fuSlc":[function(require,module,exports) {
!function(t, n) {
    module.exports = n();
...
},{"./mount.js":"5qTJ0","./unmount.js":"irGDu","./util.js":"84GoL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6DoTH","adjPd"], "adjPd", "parcelRequire62d8")
